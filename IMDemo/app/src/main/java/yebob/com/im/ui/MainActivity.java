...
import yebob.com.im.Constant;
import yebob.com.im.DemoHelper;
...
//	private ChatAllHistoryFragment conversationListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments = new Fragment[]{contactFragment, conversationListFragment, settingFragment};
        // 添加显示第一个fragment
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, contactFragment)
              /*  .add(R.id.fragment_container, conversationListFragment).hide(conversationListFragment).show(contactFragment)*/
                .commit();
